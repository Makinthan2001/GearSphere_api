...
// // Get budget from query parameters
// $budget = isset($_GET['budget']) ? (float)$_GET['budget'] : 0;
// if ($budget <= 0) {
//     echo json_encode(['success' => false, 'message' => 'Invalid budget']);
//     exit;
...
// // Component weight distribution (including monitor)
// $weights = [
//     'cpu'         => 0.18,
//     'motherboard' => 0.13,
//     'ram'         => 0.10,
...
// // Create compare instance (reserved for future enhancements)
// $compare = new Compare_product($pdo);

// /**
//  * Get the best (most expensive under budget) product from a component table
//  */
// function getBestAffordable($pdo, $table, $maxPrice) {
//     $sql = "
//         SELECT p.* FROM products p
