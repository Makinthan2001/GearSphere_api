<?php
/**
 * Get Memory API Endpoint
 * 
 * This script retrieves all memory/RAM products with detailed specifications.
 * It handles:
 * - Memory data retrieval with complete product details
 * - Error handling for database issues
 * - JSON response formatting for product comparison
 * 
 * Method: GET
 * Returns: Array of memory products with detailed specifications
 */
...
try {
    ...
    // Retrieve all memory products with detailed specifications
    $memory = $product->getAllMemoryWithDetails();
    
    // Return successful response with memory data
    echo json_encode([
        'success' => true,
        'data' => $memory
    ]);
