<?php
/**
 * Seller Notification Management API Endpoint
 * 
 * This script handles seller notification operations including:
 * - Retrieving all seller notifications
...
// Include the Notification class for database operations
...
// Handle GET request to retrieve all notifications for the seller
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        // Fetch all notifications for the authenticated seller
